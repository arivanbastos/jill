 ...
 *
 * https://github.com/google/uribeacon/blob/master/android-uribeacon/uribeacon-library/src/main/java/org/uribeacon/scan/util/RangingUtils.java
 */
...
public class RangingUtil {
   ...
   */
    ...
    /**
     * http://stackoverflow.com/questions/11217674/how-to-calculate-distance-from-wifi-router-using-signal-strength#answer-18359639
     * @param signalLevelInDb BLE Signal Level
     * @param freqInMHz 2450 for BLE
     * @return distance in meteres.
     */
    public double estimateDistance1(double signalLevelInDb, double freqInMHz)
    {
